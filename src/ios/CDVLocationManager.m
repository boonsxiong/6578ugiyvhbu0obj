...
- (NSString*) proximityAsString: (CLProximity) proximity {
    NSDictionary *dict = @{@(CLProximityNear): @"ProximityNear-BOON",
                           @(CLProximityFar): @"ProximityFar-BOON",
                           @(CLProximityImmediate): @"ProximityImmediate-BOON",
                           @(CLProximityUnknown): @"ProximityUnknown-BOON"};
